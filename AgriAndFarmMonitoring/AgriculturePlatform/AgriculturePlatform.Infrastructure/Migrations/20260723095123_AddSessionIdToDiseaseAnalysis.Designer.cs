...
namespace AgriculturePlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260723095123_AddSessionIdToDiseaseAnalysis")]
    partial class AddSessionIdToDiseaseAnalysis
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgriculturePlatform.Domain.Entities.CropMonitoring.Field", b =>
                {
                    ...
                    b.Property<List<string>>("AdditionalImagePaths")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("AgriculturePlatform.Domain.Entities.CropMonitoring.WeatherAlert", b =>
                {
                    ...
                    b.Property<int?>("ResolvedByWorkerId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AgriculturePlatform.Domain.Entities.CropMonitoring.WeatherAlert", b =>
                {
                    ...
                    b.HasOne("AgriculturePlatform.Domain.Entities.WorkerManagement.Worker", "ResolvedByWorker")
                        .WithMany()
                        .HasForeignKey("ResolvedByWorkerId");
