...
import { WeatherData, WeatherHistoryFilter, WEATHER_CONDITIONS } from '../../../admin/models/weather.model';

// ✅ Register Chart.js components
Chart.register(...registerables);

@Component({
  selector: 'app-worker-weather-history',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class WorkerWeatherHistoryComponent implements OnInit, OnDestroy {
  ...
  loadWeatherData(): void {
    ...
    this.weatherService.getWeatherHistory(filter)
