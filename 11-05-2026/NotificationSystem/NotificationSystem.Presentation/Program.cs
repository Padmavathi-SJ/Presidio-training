    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            var _dbconfig = new DatabaseConfig
            {
                ...
                DatabaseName = Environment.GetEnvironmentVariable("DB_NAME") ?? "notification_system",
                UserName = Environment.GetEnvironmentVariable("DB_USER") ?? "postgres",
                Password = Environment.GetEnvironmentVariable("DB_PASSWORD") ?? ""
            };

            _dbConnection = new DatabaseConnection(_dbconfig);
            ...
            var userRepository = new UserRepository(_dbConnection);
            var notificationRepository = new NotificationRepository(_dbConnection);
