...
namespace BankApp.Models{
    ...
    public class Account{
        ...
        public string PhoneNumber{
            get => _phone;
            set{
                if(!value.Length != 10 || !long.TryPrse(value, out _))
        ...
        public decimal Balance{
            ...
            set{
                if(value < 0)
                    throw new ArgumentException("Balance cannot be negtive");
                _balance = value;
            }
        }
        ...
        // method overriding (polymorphism): to costomize how the account objects display as strings instead of default BankApp.Models.Account type 
